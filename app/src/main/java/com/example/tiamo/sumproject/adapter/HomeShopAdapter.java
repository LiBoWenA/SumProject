...
public class HomeShopAdapter extends RecyclerView.Adapter<HomeShopAdapter.ViewHolder> {
    ...
    private List<HomeShopBean.ResultBean> list;
    ...
    public void setData(List<HomeShopBean.ResultBean> lists){
        list.clear();
        list.addAll(lists);
        notifyDataSetChanged();
    }

    public void addData(List<HomeShopBean.ResultBean> lists){
        list.addAll(lists);
        notifyDataSetChanged();
    }
    @NonNull
    @Override
    public HomeShopAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HomeShopAdapter.ViewHolder viewHolder, final int i) {
